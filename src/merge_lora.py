...
if __name__ == "__main__":
    ...
    parser.add_argument("--load-in-8bit", action='store_true', help="Load base model in 8-bit before merging")
    parser.add_argument("--load-in-4bit", action='store_true', help="Load base model in 4-bit before merging")
